 ...
 */
public final class PubsubBatch {
    ...
    public PubsubBatch(String topic, MemoryRecords records, long now) {
        this.createdMs = now;
    ...
    public String toString() {
        return "RecordBatch(recordCount=" + recordCount + ")";
    }
    ...
    public boolean maybeExpire(int requestTimeoutMs, long retryBackoffMs, long now, long lingerMs, boolean isFull) {
        ...
        if (expire) {
            ...
            this.done(-1L, Record.NO_TIMESTAMP,
                    new TimeoutException("Expiring " + recordCount + " record(s) due to " + errorMessage));
        }
