...
public class SubscriberTest {
  ...
  static class TestReceiver implements MessageReceiver {
    ...
    void replyAllOutstandingMessage() {
  ...
  public void testGetSubscriptionZeroTimes() throws Exception {
    ...
    assertEquals(0, fakeSubscriberServiceImpl.getSubscriptionCalledCount());
  }
  ...
  @Test
  public void testManualCommitBatchAcks() throws Exception {
    Subscriber subscriber = startSubscriber(getTestSubscriberBuilder(testReceiver));
  ...
  @Test
  public void testAutoCommitBatchAcks() throws Exception {
    Subscriber subscriber = startSubscriber(getTestSubscriberBuilder(testReceiver).setAutoCommit(true)
        .setAutoCommitIntervalMs(6000));

    sendMessages(ImmutableList.of("R"));
    subscriber.pull(10000);
  ...
  private void sendMessages(Iterable<String> ackIds)
  ...
  private Builder getTestSubscriberBuilder(MessageReceiver receiver) {
    Subscription subscription = Subscription.newBuilder()
        .setName("projects/aaa/subscriptions/bbb")
        .setTopic("ccc")
